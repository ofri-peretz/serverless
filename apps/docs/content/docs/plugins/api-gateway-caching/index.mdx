...
Everything the community plugin does, plus the things it does badly or not at all. See the [migration guide](/docs/plugins/api-gateway-caching/migration#full-capability-matrix) for the full feature-by-feature comparison.
